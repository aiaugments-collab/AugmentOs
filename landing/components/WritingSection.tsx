...
export default function WritingSection() {
  const [currentSlide, setCurrentSlide] = useState(1); // Start with slide 2 (index 1) as active
  const [isAutoPlaying, setIsAutoPlaying] = useState(true);

  const slides = [
    {
      title: "An in-line copy editor to avoid the messy copy-paste",
      video: "https://stream.mux.com/u00DA3fL701wLeENZ8wQ5GD02RTkMmu8OuxNSGgm1i6x4E.m3u8",
      poster: "https://image.mux.com/u00DA3fL701wLeENZ8wQ5GD02RTkMmu8OuxNSGgm1i6x4E/thumbnail.webp?width=1920&fit_mode=preserve&time=0",
      hasImage: true,
      image: "https://cdn.sanity.io/images/e5fj2khm/production/224e62ee0cc323b1d50fe1407dcab3333e27a33e-480x400.png?auto=format&q=100&w=800"
    },
    {
      title: "An extra set of eyes to always hit your quality bar",
      video: "https://stream.mux.com/W3kq00Z52TUaFJEjCMD9p02MRB39F2it6IH01OMBCR00CpE.m3u8",
      poster: "https://image.mux.com/W3kq00Z52TUaFJEjCMD9p02MRB39F2it6IH01OMBCR00CpE/thumbnail.webp?width=1920&fit_mode=preserve&time=0",
      hasImage: false
    },
    {
      title: "Share meeting takeaways in a fraction of the time",
      video: "https://stream.mux.com/noe1pP0200PHlDX2BMaXOJg01eoTZHPpi01dN8wbW2ZCtqg.m3u8",
      poster: "https://image.mux.com/noe1pP0200PHlDX2BMaXOJg01eoTZHPpi01dN8wbW2ZCtqg/thumbnail.jpg?width=1920&fit_mode=preserve&time=0",
      hasImage: false
    },
    {
      title: "The perfect word always at your fingertips",
      video: "https://stream.mux.com/TZJmfmR4ksBqlPVjeeFHjqeWtIKwLFX59WPxBBldvdM.m3u8",
      poster: "https://image.mux.com/TZJmfmR4ksBqlPVjeeFHjqeWtIKwLFX59WPxBBldvdM/thumbnail.jpg?width=1920&fit_mode=preserve&time=0",
      hasImage: false
    }
  ];
                ...
                <div className="flex flex-col gap-5 max-w-lg">
                  ...
                  <div className="text-black/60 text-lg md:text-xl lg:text-2xl w-full text-pretty text-center px-4 p1">
                    <p dangerouslySetInnerHTML={{ 
                      __html: slides[currentSlide].title.replace(/\b(in-line copy editor|extra set of eyes|Share meeting takeaways|perfect word)\b/g, '<span class="text-black">$1</span>')
                    }} />
                  </div>
