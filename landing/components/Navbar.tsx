...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-full px-6 py-3 shadow-lg">
      ...
      {isMenuOpen && (
        ...
        >
          <div className="space-y-2">
            ...
            <a
              href="#download"
              className="bg-gray-900 text-white block px-3 py-2 text-sm font-medium rounded-full mt-2"
            >
              Get Started
            </a>
          </div>
