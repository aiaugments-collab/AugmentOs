...
export default function LearningSection() {
  ...
  const slides = [
    {
      title: "Understand both sides of an argument in one place",
      video: "https://stream.mux.com/026AEY8NTEuo01xUU00OMn39aHAUpNgNQRZDKOAf2Xql800.m3u8",
      poster: "https://image.mux.com/026AEY8NTEuo01xUU00OMn39aHAUpNgNQRZDKOAf2Xql800/thumbnail.jpg?width=1920&fit_mode=preserve&time=0",
      hasImage: false
    },
    {
      title: "YouTube timestamps to get straight to the information you want",
      video: "https://stream.mux.com/01z8JQx9ptdyNoTR4sc44zJOhJp2uO51txN1cp00PmGWU.m3u8",
      poster: "https://image.mux.com/01z8JQx9ptdyNoTR4sc44zJOhJp2uO51txN1cp00PmGWU/thumbnail.jpg?width=1920&fit_mode=preserve&time=0",
      hasImage: true,
      image: "https://cdn.sanity.io/images/e5fj2khm/production/e251059b4b41f8e5c05cc26907a35a99ab570000-480x400.png?auto=format&q=100&w=800"
    },
    {
      title: "Break down complex concepts as you go",
      video: "https://stream.mux.com/ecfgNCfsCrLS5JsAwORBcP4Ng54jnbv48lkpQFSUvr00.m3u8",
      poster: "https://image.mux.com/ecfgNCfsCrLS5JsAwORBcP4Ng54jnbv48lkpQFSUvr00/thumbnail.jpg?width=1920&fit_mode=preserve&time=0",
      hasImage: false
    },
    {
      title: "Instant summaries to zero in on what matters",
      video: "https://stream.mux.com/OTaLUimLTfqkKWfUyPVhtMburoKT1NUgKqMNhU6TCGo.m3u8",
      poster: "https://image.mux.com/OTaLUimLTfqkKWfUyPVhtMburoKT1NUgKqMNhU6TCGo/thumbnail.jpg?width=1920&fit_mode=preserve&time=0",
      hasImage: false
    }
  ];
                ...
                <div className="flex flex-col gap-5 max-w-lg">
                  ...
                  <div className="text-black/60 text-lg md:text-xl lg:text-2xl w-full text-pretty text-center px-4 p1">
                    <p dangerouslySetInnerHTML={{ 
                      __html: slides[currentSlide].title.replace(/\b(Understand|YouTube timestamps|Break down|Instant summaries)\b/g, '<span class="text-black">$1</span>')
                    }} />
                  </div>
